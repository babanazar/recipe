...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final RecipeRepository recipeCategory;
    private final UnitOfMeasureRepository unitOfMeasureRepository;

    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeCategory, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.getIngredients().add(new Ingredient("serrano chiles, stems and seed removed, mince", new BigDecimal(2), eachUom));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Roughly choppe cilantro", new BigDecimal(4), eachUom));
