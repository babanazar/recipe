...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.addIngredient(new Ingredient("serrano chiles, stems and seed removed, mince", new BigDecimal(2), eachUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("Roughly choppe cilantro", new BigDecimal(4), eachUom));
